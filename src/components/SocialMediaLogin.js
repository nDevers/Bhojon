...
const SocialMediaLoginButton = () => {
  ...
  (signInWithGoogleLoading || signInWithFacebookLoading || signInWithGithubLoading) && <LoadingSpinner />;

  // display signin error
  (signInWithGoogleError || signInWithFacebookError || signInWithGithubError) && Swal.fire({
    icon: "error",
    title: "Error",
    text: `${signInWithGoogleError || signInWithFacebookError || signInWithGithubError}`,
  });
