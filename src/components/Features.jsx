...
function Features(props) {
    return (
        <div id='features' className='bg-gradient-to-r from-green-500 via-purple-500 to-yellow-500 h-screen blur-none'>
            <h1 className='text-white text-center text-4xl font-bold pt-20'>BHOJON has some unique features which you don't find in this universe !!</h1>
