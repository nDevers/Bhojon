...
const SocialMediaLoginButton = () => {
  return (
    <div className="flex flex-col gap-2">
      ...
      <Link
        class="inline-flex items-center justify-center rounded border-2 border-[#55acee] bg-[#55acee] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#55acee] focus:outline-none focus:ring active:opacity-75"
        to="/twitter"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <Link
        class="inline-flex items-center justify-center rounded border-2 border-[#ea4c89] bg-[#ea4c89] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#ea4c89] focus:outline-none focus:ring active:opacity-75"
        to="/dribbble"
        target="_blank"
        rel="noreferrer"
      >
