    ...
    <div>
      <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 lg:gap-6 md:gap-5 gap-4">
        {summaryData?.map((summary) => (
          <div
            key={summary?.name}
            className="p-2 bg-gray-200 rounded-md flex flex-col items-center justify-center text-center"
          >
      ...
      <div className="mt-7 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-6 md:gap-5 gap-4">
        {latestSummary?.map((summary) => (
          <div className="h-96 p-2 border rounded-md overflow-y-auto">
...
export default HumanResourceSummary;
