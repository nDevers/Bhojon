  ...
  return (
    <div className="my-10">
      <div className="flex flex-col gap-5 items-center justify-center p-2 m-2">
        <Input inputTitle='Food Name' inputType='text' inputPlaceHolder='Food Name' />
        <FileInput fileInputTitle='Food Image' />
        <Select selectTitle='Category' selectOptions={['Desert', 'Drinks', 'Soup']} />
        <Select selectTitle='Menu' selectOptions={['Breakfast', 'Lunch', 'Dinner']} />
        <Select selectTitle='Select Kitchen' selectOptions={['Thai', 'Mexican', 'American']} />
        <Input inputTitle='Components' inputType='text' inputPlaceHolder='Components' />
        <Input inputTitle='Notes' inputType='text' inputPlaceHolder='Notes' />
        <TextArea textAreaTitle='Description' textAreaPlaceHolder='Description' />
