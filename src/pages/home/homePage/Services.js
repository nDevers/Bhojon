  ...
  return (
    <div className="my-16 mx-2 md:mx-10 lg:mx-16">
      <div className="p-3 m-3 col-5">
        <h2 className="text-2xl md:text-2xl lg:text-3xl font-semibold font capitalize">
          <span className="text-primary">Why</span> Choose Us
        </h2>
        <p className="mt-5 w-full md:w-2/3 lg:1/3">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate
          porro voluptatibus commodi error illum veritatis tenetur corporis modi
          labore?
        </p>
      </div>
        ...
        {services?.map((service) => (
          <div className="col-4 shadow-xl flex flex-col items-center p-4 m-4 rounded-lg">
            ...
            <div>
              ...
              <button className="flex items-center gap-4 mt-6 mb-2 cursor-pointer hover:text-primary hover:underline">
